 ...
 */
JNIEXPORT jint JNICALL Java_com_proveedoradeclimas_sacalmacen_clases_SerialPort_open
 ...
 */
JNIEXPORT jint JNICALL Java_com_proveedoradeclimas_sacalmacen_clases_SerialPort_write
 ...
 * Signature: (II)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_proveedoradeclimas_sacalmacen_clases_SerialPort_read
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_proveedoradeclimas_sacalmacen_clases_SerialPort_close
  (JNIEnv *, jobject, jint);
